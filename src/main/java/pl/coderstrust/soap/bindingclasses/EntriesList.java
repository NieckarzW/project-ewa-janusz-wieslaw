    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final EntriesList that = ((EntriesList) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "invoiceEntries", lhsInvoiceEntries), LocatorUtils.property(thatLocator, "invoiceEntries", rhsInvoiceEntries), lhsInvoiceEntries, rhsInvoiceEntries)) {
                return false;
            }
        }
        return true;
