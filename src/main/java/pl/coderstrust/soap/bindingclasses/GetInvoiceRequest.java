    ...
    implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetInvoiceRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetInvoiceRequest that = ((GetInvoiceRequest) object);
        {
            long lhsId;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GetInvoiceRequest) {
            final GetInvoiceRequest copy = ((GetInvoiceRequest) draftCopy);
            long sourceId;
