...
public class Invoice
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof Invoice) {
      Invoice copy = ((Invoice) draftCopy);
      if (id != null) {
