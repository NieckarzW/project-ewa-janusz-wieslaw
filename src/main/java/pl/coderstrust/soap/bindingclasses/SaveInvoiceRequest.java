 ...
 *       &lt;sequence&gt;
 *         &lt;element name="invoice" type="{http://project-10-ewa-januss-wieslaw}invoice"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SaveInvoiceRequest
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
    if (!(object instanceof SaveInvoiceRequest)) {
      return false;
    }
    if (this == object) {
      return true;
    }
    SaveInvoiceRequest that = ((SaveInvoiceRequest) object);
    {
      Invoice lhsInvoice;
      lhsInvoice = getInvoice();
      Invoice rhsInvoice;
      rhsInvoice = that.getInvoice();
      return strategy.equals(LocatorUtils.property(thisLocator, "invoice", lhsInvoice), LocatorUtils.property(thatLocator, "invoice", rhsInvoice), lhsInvoice, rhsInvoice);
    }
  }
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof SaveInvoiceRequest) {
      SaveInvoiceRequest copy = ((SaveInvoiceRequest) draftCopy);
      if (invoice != null) {
        Invoice sourceInvoice;
        sourceInvoice = getInvoice();
        Invoice copyInvoice = ((Invoice) strategy.copy(LocatorUtils.property(locator, "invoice", sourceInvoice), sourceInvoice));
